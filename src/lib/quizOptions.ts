...
export const occasions = [
  { id: "casual", label: "Casual Daily Wear", icon: "Sun" },
  { id: "office", label: "Office / Professional", icon: "Briefcase" },
  ...
  { id: "summer", label: "Summer Outfits", icon: "Umbrella" },
  { id: "winter", label: "Winter Outfits", icon: "Snowflake" },
];
