...
import {
  ArrowRight, Clock, Shirt,
  Sun, Briefcase, BookOpen, Heart, PartyPopper, Gem,
  Handshake, Dumbbell, Plane, Umbrella, Snowflake,
  type LucideProps,
} from "lucide-react";
...
const OCCASION_ICON_MAP: Record<string, React.ComponentType<LucideProps>> = {
  Sun, Briefcase, BookOpen, Heart, PartyPopper, Gem,
  Handshake, Dumbbell, Plane, Umbrella, Snowflake,
};

function OccasionIcon({ name, className }: { name: string; className?: string }) {
  const Icon = OCCASION_ICON_MAP[name];
  if (!Icon) return null;
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto p-4 md:p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Drippy will style outfits tailored to it</p>
        </div>
            ...
            return (
              ...
              >
                <div className="mb-2 text-primary">
                  <OccasionIcon name={occ.icon} className="h-6 w-6" />
                </div>
